(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function s(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(i){if(i.ep)return;i.ep=!0;const n=s(i);fetch(i.href,n)}})();function u(){}function A(e){return e()}function S(){return Object.create(null)}function _(e){e.forEach(A)}function k(e){return typeof e=="function"}function O(e,t){return e!=e?t==t:e!==t||e&&typeof e=="object"||typeof e=="function"}function P(e){return Object.keys(e).length===0}function I(e,t,s){e.insertBefore(t,s||null)}function q(e){e.parentNode&&e.parentNode.removeChild(e)}function z(e){return document.createElement(e)}function M(e,t,s){s==null?e.removeAttribute(t):e.getAttribute(t)!==s&&e.setAttribute(t,s)}function T(e){return Array.from(e.childNodes)}let y;function h(e){y=e}const d=[],j=[],p=[],E=[],D=Promise.resolve();let v=!1;function G(){v||(v=!0,D.then(C))}function g(e){p.push(e)}const m=new Set;let l=0;function C(){if(l!==0)return;const e=y;do{try{for(;l<d.length;){const t=d[l];l++,h(t),J(t.$$)}}catch(t){throw d.length=0,l=0,t}for(h(null),d.length=0,l=0;j.length;)j.pop()();for(let t=0;t<p.length;t+=1){const s=p[t];m.has(s)||(m.add(s),s())}p.length=0}while(d.length);for(;E.length;)E.pop()();v=!1,m.clear(),h(e)}function J(e){if(e.fragment!==null){e.update(),_(e.before_update);const t=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,t),e.after_update.forEach(g)}}const N=new Set;function R(e,t){e&&e.i&&(N.delete(e),e.i(t))}function V(e,t,s,a){const{fragment:i,after_update:n}=e.$$;i&&i.m(t,s),a||g(()=>{const c=e.$$.on_mount.map(A).filter(k);e.$$.on_destroy?e.$$.on_destroy.push(...c):_(c),e.$$.on_mount=[]}),n.forEach(g)}function B(e,t){const s=e.$$;s.fragment!==null&&(_(s.on_destroy),s.fragment&&s.fragment.d(t),s.on_destroy=s.fragment=null,s.ctx=[])}function F(e,t){e.$$.dirty[0]===-1&&(d.push(e),G(),e.$$.dirty.fill(0)),e.$$.dirty[t/31|0]|=1<<t%31}function H(e,t,s,a,i,n,c,L=[-1]){const f=y;h(e);const r=e.$$={fragment:null,ctx:[],props:n,update:u,not_equal:i,bound:S(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(f?f.$$.context:[])),callbacks:S(),dirty:L,skip_bound:!1,root:t.target||f.$$.root};c&&c(r.root);let b=!1;if(r.ctx=s?s(e,t.props||{},(o,w,...x)=>{const $=x.length?x[0]:w;return r.ctx&&i(r.ctx[o],r.ctx[o]=$)&&(!r.skip_bound&&r.bound[o]&&r.bound[o]($),b&&F(e,o)),w}):[],r.update(),b=!0,_(r.before_update),r.fragment=a?a(r.ctx):!1,t.target){if(t.hydrate){const o=T(t.target);r.fragment&&r.fragment.l(o),o.forEach(q)}else r.fragment&&r.fragment.c();t.intro&&R(e.$$.fragment),V(e,t.target,t.anchor,t.customElement),C()}h(f)}class W{$destroy(){B(this,1),this.$destroy=u}$on(t,s){if(!k(s))return u;const a=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return a.push(s),()=>{const i=a.indexOf(s);i!==-1&&a.splice(i,1)}}$set(t){this.$$set&&!P(t)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}function K(e){let t;return{c(){t=z("body"),t.innerHTML=`<header class="header__cv"><nav><div><div class="roundfirst"></div> 
        <div class="roundsecond"></div> 
        <div class="roundthird"></div></div></nav> 

    
    <section><h1>Tamara VIOLEAU</h1> 
      <div class="section__h2"><div class="title__h2"><h2>Développeuse front-end</h2></div></div> 
  ...
  <footer></footer>`,M(t,"class","body__cv")},m(s,a){I(s,t,a)},p:u,i:u,o:u,d(s){s&&q(t)}}}class Q extends W{constructor(t){super(),H(this,t,null,K,O,{})}}new Q({target:document.getElementById("app")});
